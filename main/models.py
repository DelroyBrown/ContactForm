...
class InfoFormModel(models.Model):
    ...
    would_you_like_one_created = models.CharField(
        choices=YES_NO, blank=False, null=False, max_length=100, default='yes')
    ...
    pages_needed = models.TextField(blank=True, null=True, max_length=3000, default='')


    class Meta:
        verbose_name_plural = 'Contact form info'
